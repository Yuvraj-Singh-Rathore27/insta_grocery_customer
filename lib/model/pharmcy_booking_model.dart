...
import 'package:insta_grocery_customer/model/pharmacy_booking_model.dart';
...
class PharmacyBookingModel {
  ...
  PharmacyDetailsBookingModel ? pharmacyDetails;

  PharmacyBookingModel(
      {this.id,
        this.prescription,
        this.updatedById,
        this.isActive,
  ...
  PharmacyBookingModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    deliveryBoyBookingModel= json['delivery'] != null
        ...
        : null;
    pharmacyDetails= json['pharmacy'] != null
        ?  PharmacyDetailsBookingModel.fromJson(json['pharmacy'])
        : null;
