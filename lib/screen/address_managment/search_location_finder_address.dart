...
class SearchLocationAddressFinder extends StatefulWidget {
  final String type;
  SearchLocationAddressFinder({Key? key, required this.type}) : super(key: key);

  @override
  State<SearchLocationAddressFinder> createState() => _SearchLocationFinderState(type);
}

class _SearchLocationFinderState extends State<SearchLocationAddressFinder> {
                  ...
                  return LocationListTile(
                    ...
                    press: () {
                      if(type=="pickup"){
                        ...
                        controller.getPlaceDetails(controller.pickupLocation.value.placeId,"pickup");
                      }
