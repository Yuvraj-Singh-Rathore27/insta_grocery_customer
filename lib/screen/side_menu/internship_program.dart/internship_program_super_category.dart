...
import 'internship_category.dart';

class InternshipSuperCategoryScreen extends StatelessWidget {
  InternshipSuperCategoryScreen({super.key});
  ...
  Get.to(() => InternshipCategoryScreen(superCategoryId: id));
},
                      child: Container(
