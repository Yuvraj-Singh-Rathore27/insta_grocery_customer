        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 16),
              // ✅ FIXED: Removed duplicate SizedBox and fixed Row structure
             Row(
  mainAxisAlignment: MainAxisAlignment.spaceBetween,
  children: [
    Obx(() => _buildSummaryBox(
...
,
    ...
    Obx(() => _buildSummaryBox(
      sellerController.productViewsCount.value,
      "Product\nviews",
      Colors.blue.shade50,
    )),
    Obx(() => _buildSummaryBox(
      sellerController.enquiriesCount.value,
      "Enquiries",
