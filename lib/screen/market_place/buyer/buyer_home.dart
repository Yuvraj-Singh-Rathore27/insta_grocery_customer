    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText:
              "Search products...", // use hintText instead of labelText for cleaner look
          hintStyle: TextStyle(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: // ---------------- CATEGORY LIST ----------------
                ...
                shrinkWrap: true,
                physics:
                    NeverScrollableScrollPhysics(), // parent scroll handle karega
                          ...
                          return GestureDetector(
                            onTap: () async {
                              ...
                              await buyerController.loadMarketPlaceProducts(
                                categoryId:
                                    buyerController.selectedCategory.value.id!,
                          ...
                          child: Column(
                            children: [
                              Obx(() => IconButton(
                                    ...
                                    icon: Icon(
                                      item.isInterested.value
                                          ? Icons.favorite
                                          : Icons.favorite_border,
                                      color: item.isInterested.value
                                          ? Colors.red
                                          : Colors.grey,
                                    ),
                                  )),
